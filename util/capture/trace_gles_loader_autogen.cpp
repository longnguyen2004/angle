...
ANGLE_TRACE_LOADER_EXPORT PFNGLGETPERFMONITORCOUNTERSTRINGAMDPROC t_glGetPerfMonitorCounterStringAMD;
...
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERMEMORYLESSPIXELLOCALSTORAGEANGLEPROC t_glFramebufferMemorylessPixelLocalStorageANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEFVANGLEPROC t_glFramebufferPixelLocalClearValuefvANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEIVANGLEPROC t_glFramebufferPixelLocalClearValueivANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEUIVANGLEPROC t_glFramebufferPixelLocalClearValueuivANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERPIXELLOCALSTORAGEINTERRUPTANGLEPROC t_glFramebufferPixelLocalStorageInterruptANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERPIXELLOCALSTORAGERESTOREANGLEPROC t_glFramebufferPixelLocalStorageRestoreANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERTEXTUREPIXELLOCALSTORAGEANGLEPROC t_glFramebufferTexturePixelLocalStorageANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERFVANGLEPROC t_glGetFramebufferPixelLocalStorageParameterfvANGLE;
...
ANGLE_TRACE_LOADER_EXPORT PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERIVROBUSTANGLEPROC t_glGetFramebufferPixelLocalStorageParameterivRobustANGLE;
...
ANGLE_TRACE_LOADER_EXPORT PFNGLEGLIMAGETARGETTEXTURESTORAGEEXTPROC t_glEGLImageTargetTextureStorageEXT;
ANGLE_TRACE_LOADER_EXPORT PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEEXTPROC t_glDrawArraysInstancedBaseInstanceEXT;
ANGLE_TRACE_LOADER_EXPORT PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEEXTPROC t_glDrawElementsInstancedBaseInstanceEXT;
ANGLE_TRACE_LOADER_EXPORT PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEEXTPROC t_glDrawElementsInstancedBaseVertexBaseInstanceEXT;
...
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERFOVEATIONCONFIGQCOMPROC t_glFramebufferFoveationConfigQCOM;
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERFOVEATIONPARAMETERSQCOMPROC t_glFramebufferFoveationParametersQCOM;
ANGLE_TRACE_LOADER_EXPORT PFNGLSHADINGRATEQCOMPROC t_glShadingRateQCOM;
ANGLE_TRACE_LOADER_EXPORT PFNGLTEXTUREFOVEATIONPARAMETERSQCOMPROC t_glTextureFoveationParametersQCOM;
...
void LoadTraceGLES(LoadProc loadProc)
{
    ...
    t_glBeginPerfMonitorAMD = reinterpret_cast<PFNGLBEGINPERFMONITORAMDPROC>(loadProc("glBeginPerfMonitorAMD"));
    t_glDeletePerfMonitorsAMD = reinterpret_cast<PFNGLDELETEPERFMONITORSAMDPROC>(loadProc("glDeletePerfMonitorsAMD"));
    t_glEndPerfMonitorAMD = reinterpret_cast<PFNGLENDPERFMONITORAMDPROC>(loadProc("glEndPerfMonitorAMD"));
    t_glGenPerfMonitorsAMD = reinterpret_cast<PFNGLGENPERFMONITORSAMDPROC>(loadProc("glGenPerfMonitorsAMD"));
    t_glGetPerfMonitorCounterDataAMD = reinterpret_cast<PFNGLGETPERFMONITORCOUNTERDATAAMDPROC>(loadProc("glGetPerfMonitorCounterDataAMD"));
    t_glGetPerfMonitorCounterInfoAMD = reinterpret_cast<PFNGLGETPERFMONITORCOUNTERINFOAMDPROC>(loadProc("glGetPerfMonitorCounterInfoAMD"));
    t_glGetPerfMonitorCounterStringAMD = reinterpret_cast<PFNGLGETPERFMONITORCOUNTERSTRINGAMDPROC>(loadProc("glGetPerfMonitorCounterStringAMD"));
    t_glGetPerfMonitorCountersAMD = reinterpret_cast<PFNGLGETPERFMONITORCOUNTERSAMDPROC>(loadProc("glGetPerfMonitorCountersAMD"));
    t_glGetPerfMonitorGroupStringAMD = reinterpret_cast<PFNGLGETPERFMONITORGROUPSTRINGAMDPROC>(loadProc("glGetPerfMonitorGroupStringAMD"));
    t_glGetPerfMonitorGroupsAMD = reinterpret_cast<PFNGLGETPERFMONITORGROUPSAMDPROC>(loadProc("glGetPerfMonitorGroupsAMD"));
    t_glSelectPerfMonitorCountersAMD = reinterpret_cast<PFNGLSELECTPERFMONITORCOUNTERSAMDPROC>(loadProc("glSelectPerfMonitorCountersAMD"));
    ...
    t_glBlobCacheCallbacksANGLE = reinterpret_cast<PFNGLBLOBCACHECALLBACKSANGLEPROC>(loadProc("glBlobCacheCallbacksANGLE"));
    t_glGetPointervANGLE = reinterpret_cast<PFNGLGETPOINTERVANGLEPROC>(loadProc("glGetPointervANGLE"));
    ...
    t_glGetCompressedTexImageANGLE = reinterpret_cast<PFNGLGETCOMPRESSEDTEXIMAGEANGLEPROC>(loadProc("glGetCompressedTexImageANGLE"));
    ...
    t_glPolygonModeANGLE = reinterpret_cast<PFNGLPOLYGONMODEANGLEPROC>(loadProc("glPolygonModeANGLE"));
    ...
    t_glBeginPixelLocalStorageANGLE = reinterpret_cast<PFNGLBEGINPIXELLOCALSTORAGEANGLEPROC>(loadProc("glBeginPixelLocalStorageANGLE"));
    t_glEndPixelLocalStorageANGLE = reinterpret_cast<PFNGLENDPIXELLOCALSTORAGEANGLEPROC>(loadProc("glEndPixelLocalStorageANGLE"));
    t_glFramebufferMemorylessPixelLocalStorageANGLE = reinterpret_cast<PFNGLFRAMEBUFFERMEMORYLESSPIXELLOCALSTORAGEANGLEPROC>(loadProc("glFramebufferMemorylessPixelLocalStorageANGLE"));
    t_glFramebufferPixelLocalClearValuefvANGLE = reinterpret_cast<PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEFVANGLEPROC>(loadProc("glFramebufferPixelLocalClearValuefvANGLE"));
    t_glFramebufferPixelLocalClearValueivANGLE = reinterpret_cast<PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEIVANGLEPROC>(loadProc("glFramebufferPixelLocalClearValueivANGLE"));
    t_glFramebufferPixelLocalClearValueuivANGLE = reinterpret_cast<PFNGLFRAMEBUFFERPIXELLOCALCLEARVALUEUIVANGLEPROC>(loadProc("glFramebufferPixelLocalClearValueuivANGLE"));
    t_glFramebufferPixelLocalStorageInterruptANGLE = reinterpret_cast<PFNGLFRAMEBUFFERPIXELLOCALSTORAGEINTERRUPTANGLEPROC>(loadProc("glFramebufferPixelLocalStorageInterruptANGLE"));
    t_glFramebufferPixelLocalStorageRestoreANGLE = reinterpret_cast<PFNGLFRAMEBUFFERPIXELLOCALSTORAGERESTOREANGLEPROC>(loadProc("glFramebufferPixelLocalStorageRestoreANGLE"));
    t_glFramebufferTexturePixelLocalStorageANGLE = reinterpret_cast<PFNGLFRAMEBUFFERTEXTUREPIXELLOCALSTORAGEANGLEPROC>(loadProc("glFramebufferTexturePixelLocalStorageANGLE"));
    t_glGetFramebufferPixelLocalStorageParameterfvANGLE = reinterpret_cast<PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERFVANGLEPROC>(loadProc("glGetFramebufferPixelLocalStorageParameterfvANGLE"));
    t_glGetFramebufferPixelLocalStorageParameterfvRobustANGLE = reinterpret_cast<PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERFVROBUSTANGLEPROC>(loadProc("glGetFramebufferPixelLocalStorageParameterfvRobustANGLE"));
    t_glGetFramebufferPixelLocalStorageParameterivANGLE = reinterpret_cast<PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERIVANGLEPROC>(loadProc("glGetFramebufferPixelLocalStorageParameterivANGLE"));
    t_glGetFramebufferPixelLocalStorageParameterivRobustANGLE = reinterpret_cast<PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERIVROBUSTANGLEPROC>(loadProc("glGetFramebufferPixelLocalStorageParameterivRobustANGLE"));
    t_glPixelLocalStorageBarrierANGLE = reinterpret_cast<PFNGLPIXELLOCALSTORAGEBARRIERANGLEPROC>(loadProc("glPixelLocalStorageBarrierANGLE"));
    ...
    t_glAcquireTexturesANGLE = reinterpret_cast<PFNGLACQUIRETEXTURESANGLEPROC>(loadProc("glAcquireTexturesANGLE"));
    t_glReleaseTexturesANGLE = reinterpret_cast<PFNGLRELEASETEXTURESANGLEPROC>(loadProc("glReleaseTexturesANGLE"));
    ...
    t_glEGLImageTargetTexStorageEXT = reinterpret_cast<PFNGLEGLIMAGETARGETTEXSTORAGEEXTPROC>(loadProc("glEGLImageTargetTexStorageEXT"));
    t_glEGLImageTargetTextureStorageEXT = reinterpret_cast<PFNGLEGLIMAGETARGETTEXTURESTORAGEEXTPROC>(loadProc("glEGLImageTargetTextureStorageEXT"));
    t_glDrawArraysInstancedBaseInstanceEXT = reinterpret_cast<PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEEXTPROC>(loadProc("glDrawArraysInstancedBaseInstanceEXT"));
    t_glDrawElementsInstancedBaseInstanceEXT = reinterpret_cast<PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEEXTPROC>(loadProc("glDrawElementsInstancedBaseInstanceEXT"));
    t_glDrawElementsInstancedBaseVertexBaseInstanceEXT = reinterpret_cast<PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEEXTPROC>(loadProc("glDrawElementsInstancedBaseVertexBaseInstanceEXT"));
    ...
    t_glClearTexImageEXT = reinterpret_cast<PFNGLCLEARTEXIMAGEEXTPROC>(loadProc("glClearTexImageEXT"));
    t_glClearTexSubImageEXT = reinterpret_cast<PFNGLCLEARTEXSUBIMAGEEXTPROC>(loadProc("glClearTexSubImageEXT"));
    ...
    t_glMultiDrawArraysIndirectEXT = reinterpret_cast<PFNGLMULTIDRAWARRAYSINDIRECTEXTPROC>(loadProc("glMultiDrawArraysIndirectEXT"));
    t_glMultiDrawElementsIndirectEXT = reinterpret_cast<PFNGLMULTIDRAWELEMENTSINDIRECTEXTPROC>(loadProc("glMultiDrawElementsIndirectEXT"));
    ...
    t_glPolygonOffsetClampEXT = reinterpret_cast<PFNGLPOLYGONOFFSETCLAMPEXTPROC>(loadProc("glPolygonOffsetClampEXT"));
    t_glPrimitiveBoundingBoxEXT = reinterpret_cast<PFNGLPRIMITIVEBOUNDINGBOXEXTPROC>(loadProc("glPrimitiveBoundingBoxEXT"));
    ...
    t_glGetSamplerParameterIivEXT = reinterpret_cast<PFNGLGETSAMPLERPARAMETERIIVEXTPROC>(loadProc("glGetSamplerParameterIivEXT"));
    t_glGetSamplerParameterIuivEXT = reinterpret_cast<PFNGLGETSAMPLERPARAMETERIUIVEXTPROC>(loadProc("glGetSamplerParameterIuivEXT"));
    t_glGetTexParameterIivEXT = reinterpret_cast<PFNGLGETTEXPARAMETERIIVEXTPROC>(loadProc("glGetTexParameterIivEXT"));
    t_glGetTexParameterIuivEXT = reinterpret_cast<PFNGLGETTEXPARAMETERIUIVEXTPROC>(loadProc("glGetTexParameterIuivEXT"));
    t_glSamplerParameterIivEXT = reinterpret_cast<PFNGLSAMPLERPARAMETERIIVEXTPROC>(loadProc("glSamplerParameterIivEXT"));
    t_glSamplerParameterIuivEXT = reinterpret_cast<PFNGLSAMPLERPARAMETERIUIVEXTPROC>(loadProc("glSamplerParameterIuivEXT"));
    t_glTexParameterIivEXT = reinterpret_cast<PFNGLTEXPARAMETERIIVEXTPROC>(loadProc("glTexParameterIivEXT"));
    t_glTexParameterIuivEXT = reinterpret_cast<PFNGLTEXPARAMETERIUIVEXTPROC>(loadProc("glTexParameterIuivEXT"));
    ...
    t_glTexStorageAttribs2DEXT = reinterpret_cast<PFNGLTEXSTORAGEATTRIBS2DEXTPROC>(loadProc("glTexStorageAttribs2DEXT"));
    t_glTexStorageAttribs3DEXT = reinterpret_cast<PFNGLTEXSTORAGEATTRIBS3DEXTPROC>(loadProc("glTexStorageAttribs3DEXT"));
    ...
    t_glGetGraphicsResetStatusKHR = reinterpret_cast<PFNGLGETGRAPHICSRESETSTATUSKHRPROC>(loadProc("glGetGraphicsResetStatusKHR"));
    t_glGetnUniformfvKHR = reinterpret_cast<PFNGLGETNUNIFORMFVKHRPROC>(loadProc("glGetnUniformfvKHR"));
    t_glGetnUniformivKHR = reinterpret_cast<PFNGLGETNUNIFORMIVKHRPROC>(loadProc("glGetnUniformivKHR"));
    t_glGetnUniformuivKHR = reinterpret_cast<PFNGLGETNUNIFORMUIVKHRPROC>(loadProc("glGetnUniformuivKHR"));
    t_glReadnPixelsKHR = reinterpret_cast<PFNGLREADNPIXELSKHRPROC>(loadProc("glReadnPixelsKHR"));
    t_glFramebufferParameteriMESA = reinterpret_cast<PFNGLFRAMEBUFFERPARAMETERIMESAPROC>(loadProc("glFramebufferParameteriMESA"));
    t_glGetFramebufferParameterivMESA = reinterpret_cast<PFNGLGETFRAMEBUFFERPARAMETERIVMESAPROC>(loadProc("glGetFramebufferParameterivMESA"));
    ...
    t_glFramebufferTextureOES = reinterpret_cast<PFNGLFRAMEBUFFERTEXTUREOESPROC>(loadProc("glFramebufferTextureOES"));
    ...
    t_glPrimitiveBoundingBoxOES = reinterpret_cast<PFNGLPRIMITIVEBOUNDINGBOXOESPROC>(loadProc("glPrimitiveBoundingBoxOES"));
    t_glMinSampleShadingOES = reinterpret_cast<PFNGLMINSAMPLESHADINGOESPROC>(loadProc("glMinSampleShadingOES"));
    t_glPatchParameteriOES = reinterpret_cast<PFNGLPATCHPARAMETERIOESPROC>(loadProc("glPatchParameteriOES"));
    ...
    t_glFramebufferFoveationConfigQCOM = reinterpret_cast<PFNGLFRAMEBUFFERFOVEATIONCONFIGQCOMPROC>(loadProc("glFramebufferFoveationConfigQCOM"));
    t_glFramebufferFoveationParametersQCOM = reinterpret_cast<PFNGLFRAMEBUFFERFOVEATIONPARAMETERSQCOMPROC>(loadProc("glFramebufferFoveationParametersQCOM"));
    t_glShadingRateQCOM = reinterpret_cast<PFNGLSHADINGRATEQCOMPROC>(loadProc("glShadingRateQCOM"));
    t_glTextureFoveationParametersQCOM = reinterpret_cast<PFNGLTEXTUREFOVEATIONPARAMETERSQCOMPROC>(loadProc("glTextureFoveationParametersQCOM"));
    ...
    t_glBlendEquationOES = reinterpret_cast<PFNGLBLENDEQUATIONOESPROC>(loadProc("glBlendEquationOES"));
