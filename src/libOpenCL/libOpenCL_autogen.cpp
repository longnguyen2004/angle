...
{
    return cl::GetDispatch().clGetPlatformInfo(platform, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetDeviceIDs(platform, device_type, num_entries, devices, num_devices);
}
...
{
    return cl::GetDispatch().clGetDeviceInfo(device, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clCreateContext(properties, num_devices, devices, pfn_notify, user_data, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateContextFromType(properties, device_type, pfn_notify, user_data, errcode_ret);
}
...
{
    return cl::GetDispatch().clGetContextInfo(context, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetCommandQueueInfo(command_queue, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetSupportedImageFormats(context, flags, image_type, num_entries, image_formats, num_image_formats);
}
...
{
    return cl::GetDispatch().clGetMemObjectInfo(memobj, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetImageInfo(image, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetSamplerInfo(sampler, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clCreateProgramWithSource(context, count, strings, lengths, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateProgramWithBinary(context, num_devices, device_list, lengths, binaries, binary_status, errcode_ret);
}
...
{
    return cl::GetDispatch().clBuildProgram(program, num_devices, device_list, options, pfn_notify, user_data);
}
...
{
    return cl::GetDispatch().clGetProgramInfo(program, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetProgramBuildInfo(program, device, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clCreateKernelsInProgram(program, num_kernels, kernels, num_kernels_ret);
}
...
{
    return cl::GetDispatch().clGetKernelInfo(kernel, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetKernelWorkGroupInfo(kernel, device, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetEventInfo(event, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clGetEventProfilingInfo(event, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clEnqueueReadBuffer(command_queue, buffer, blocking_read, offset, size, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueWriteBuffer(command_queue, buffer, blocking_write, offset, size, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueCopyBuffer(command_queue, src_buffer, dst_buffer, src_offset, dst_offset, size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueReadImage(command_queue, image, blocking_read, origin, region, row_pitch, slice_pitch, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueWriteImage(command_queue, image, blocking_write, origin, region, input_row_pitch, input_slice_pitch, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueCopyImage(command_queue, src_image, dst_image, src_origin, dst_origin, region, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueCopyImageToBuffer(command_queue, src_image, dst_buffer, src_origin, region, dst_offset, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueCopyBufferToImage(command_queue, src_buffer, dst_image, src_offset, dst_origin, region, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueMapBuffer(command_queue, buffer, blocking_map, map_flags, offset, size, num_events_in_wait_list, event_wait_list, event, errcode_ret);
}
...
{
    return cl::GetDispatch().clEnqueueMapImage(command_queue, image, blocking_map, map_flags, origin, region, image_row_pitch, image_slice_pitch, num_events_in_wait_list, event_wait_list, event, errcode_ret);
}
...
{
    return cl::GetDispatch().clEnqueueUnmapMemObject(command_queue, memobj, mapped_ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueNDRangeKernel(command_queue, kernel, work_dim, global_work_offset, global_work_size, local_work_size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueNativeKernel(command_queue, user_func, args, cb_args, num_mem_objects, mem_list, args_mem_loc, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clSetCommandQueueProperty(command_queue, properties, enable, old_properties);
}
...
{
    return cl::GetDispatch().clCreateImage2D(context, flags, image_format, image_width, image_height, image_row_pitch, host_ptr, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateImage3D(context, flags, image_format, image_width, image_height, image_depth, image_row_pitch, image_slice_pitch, host_ptr, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateSampler(context, normalized_coords, addressing_mode, filter_mode, errcode_ret);
}
...
{
    return cl::GetDispatch().clEnqueueTask(command_queue, kernel, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clCreateSubBuffer(buffer, flags, buffer_create_type, buffer_create_info, errcode_ret);
}
...
{
    return cl::GetDispatch().clSetEventCallback(event, command_exec_callback_type, pfn_notify, user_data);
}
...
{
    return cl::GetDispatch().clEnqueueReadBufferRect(command_queue, buffer, blocking_read, buffer_origin, host_origin, region, buffer_row_pitch, buffer_slice_pitch, host_row_pitch, host_slice_pitch, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueWriteBufferRect(command_queue, buffer, blocking_write, buffer_origin, host_origin, region, buffer_row_pitch, buffer_slice_pitch, host_row_pitch, host_slice_pitch, ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueCopyBufferRect(command_queue, src_buffer, dst_buffer, src_origin, dst_origin, region, src_row_pitch, src_slice_pitch, dst_row_pitch, dst_slice_pitch, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clCreateSubDevices(in_device, properties, num_devices, out_devices, num_devices_ret);
}
...
{
    return cl::GetDispatch().clCreateImage(context, flags, image_format, image_desc, host_ptr, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateProgramWithBuiltInKernels(context, num_devices, device_list, kernel_names, errcode_ret);
}
...
{
    return cl::GetDispatch().clCompileProgram(program, num_devices, device_list, options, num_input_headers, input_headers, header_include_names, pfn_notify, user_data);
}
...
{
    return cl::GetDispatch().clLinkProgram(context, num_devices, device_list, options, num_input_programs, input_programs, pfn_notify, user_data, errcode_ret);
}
...
{
    return cl::GetDispatch().clGetKernelArgInfo(kernel, arg_index, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clEnqueueFillBuffer(command_queue, buffer, pattern, pattern_size, offset, size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueFillImage(command_queue, image, fill_color, origin, region, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueMigrateMemObjects(command_queue, num_mem_objects, mem_objects, flags, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueMarkerWithWaitList(command_queue, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueBarrierWithWaitList(command_queue, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clCreateCommandQueueWithProperties(context, device, properties, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreatePipe(context, flags, pipe_packet_size, pipe_max_packets, properties, errcode_ret);
}
...
{
    return cl::GetDispatch().clGetPipeInfo(pipe, param_name, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clCreateSamplerWithProperties(context, sampler_properties, errcode_ret);
}
...
{
    return cl::GetDispatch().clEnqueueSVMFree(command_queue, num_svm_pointers, svm_pointers, pfn_free_func, user_data, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueSVMMemcpy(command_queue, blocking_copy, dst_ptr, src_ptr, size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueSVMMemFill(command_queue, svm_ptr, pattern, pattern_size, size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueSVMMap(command_queue, blocking_map, flags, svm_ptr, size, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clEnqueueSVMUnmap(command_queue, svm_ptr, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clGetKernelSubGroupInfo(kernel, device, param_name, input_value_size, input_value, param_value_size, param_value, param_value_size_ret);
}
...
{
    return cl::GetDispatch().clEnqueueSVMMigrateMem(command_queue, num_svm_pointers, svm_pointers, sizes, flags, num_events_in_wait_list, event_wait_list, event);
}
...
{
    return cl::GetDispatch().clSetProgramSpecializationConstant(program, spec_id, spec_size, spec_value);
}
...
{
    return cl::GetDispatch().clCreateBufferWithProperties(context, properties, flags, size, host_ptr, errcode_ret);
}
...
{
    return cl::GetDispatch().clCreateImageWithProperties(context, properties, flags, image_format, image_desc, host_ptr, errcode_ret);
}
