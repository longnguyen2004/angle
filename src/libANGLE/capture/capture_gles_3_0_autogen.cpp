...
CallCapture CaptureBindTransformFeedback(const State & glState, bool isCallValid, GLenum target, TransformFeedbackID idPacked)
{
    ...
    paramBuffer.addEnumParam("target", GLESEnum::BindTransformFeedbackTarget, ParamType::TGLenum, target);
...
CallCapture CaptureClientWaitSync(const State & glState, bool isCallValid, SyncID syncPacked, GLbitfield flags, GLuint64 timeout, GLenum returnValue)
{
    ParamBuffer paramBuffer;
...
CallCapture CaptureGetInternalformativ(const State & glState, bool isCallValid, GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint * params)
{
    ParamBuffer paramBuffer;
    ...
    if (isCallValid)
    {
        ParamCapture paramsParam("params", ParamType::TGLintPointer);
        InitParamValue(ParamType::TGLintPointer, params, &paramsParam.value);
        CaptureGetInternalformativ_params(glState, isCallValid, target, internalformat, pname, count, params, &paramsParam);
        paramBuffer.addParam(std::move(paramsParam));
    }
    else
    {
...
CallCapture CaptureGetSynciv(const State & glState, bool isCallValid, SyncID syncPacked, GLenum pname, GLsizei count, GLsizei * length, GLint * values)
{
    ParamBuffer paramBuffer;
    ...
    if (isCallValid)
    {
        ParamCapture lengthParam("length", ParamType::TGLsizeiPointer);
        InitParamValue(ParamType::TGLsizeiPointer, length, &lengthParam.value);
        CaptureGetSynciv_length(glState, isCallValid, syncPacked, pname, count, length, values, &lengthParam);
        paramBuffer.addParam(std::move(lengthParam));
    }
    else
    {
    ...
    if (isCallValid)
    {
        ...
        CaptureGetSynciv_values(glState, isCallValid, syncPacked, pname, count, length, values, &valuesParam);
...
CallCapture CaptureIsSync(const State & glState, bool isCallValid, SyncID syncPacked, GLboolean returnValue)
{
    ParamBuffer paramBuffer;
...
CallCapture CaptureTransformFeedbackVaryings(const State & glState, bool isCallValid, ShaderProgramID programPacked, GLsizei count, const GLchar *const* varyings, GLenum bufferMode)
{
    ...
    paramBuffer.addEnumParam("bufferMode", GLESEnum::TransformFeedbackBufferMode, ParamType::TGLenum, bufferMode);
...
CallCapture CaptureWaitSync(const State & glState, bool isCallValid, SyncID syncPacked, GLbitfield flags, GLuint64 timeout)
{
    ParamBuffer paramBuffer;
