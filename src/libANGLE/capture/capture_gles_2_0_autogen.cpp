...
CallCapture CaptureBlendFuncSeparate(const State & glState, bool isCallValid, GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha)
{
    ...
    paramBuffer.addEnumParam("sfactorRGB", GLESEnum::BlendingFactor, ParamType::TGLenum, sfactorRGB);
    paramBuffer.addEnumParam("dfactorRGB", GLESEnum::BlendingFactor, ParamType::TGLenum, dfactorRGB);
    paramBuffer.addEnumParam("sfactorAlpha", GLESEnum::BlendingFactor, ParamType::TGLenum, sfactorAlpha);
    paramBuffer.addEnumParam("dfactorAlpha", GLESEnum::BlendingFactor, ParamType::TGLenum, dfactorAlpha);
...
CallCapture CaptureGetShaderPrecisionFormat(const State & glState, bool isCallValid, GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision)
{
    ...
    paramBuffer.addEnumParam("precisiontype", GLESEnum::PrecisionType, ParamType::TGLenum, precisiontype);
...
CallCapture CaptureShaderBinary(const State & glState, bool isCallValid, GLsizei count, const ShaderProgramID * shadersPacked, GLenum binaryFormat, const void * binary, GLsizei length)
{
    ...
    paramBuffer.addEnumParam("binaryFormat", GLESEnum::ShaderBinaryFormat, ParamType::TGLenum, binaryFormat);
